...
public class Assignment04 { 
	public static void main(String args[]) {
		...
		// Output the times
		System.out.print("It took " + sortTime.getElapsedTime() + " milliseconds ("+ sortTime.getElapsedTime()/1000 +" seconds) to sort an array with " + sortingArray.length + " numbers between 1-1000.");
